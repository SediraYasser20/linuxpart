...
/**
 * \file    admin/customerreturnline_extrafields.php
 * \ingroup customerreturns
 * \brief   CustomerReturn lines extrafields setup page
 */
...
$elementtype = 'customerreturndet'; // Must match the lines table
...
print dol_get_fiche_head($head, 'extrafields_lines', $title, -1, 'customerreturn@customerreturn');
